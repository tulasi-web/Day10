...
print("------------------------------------------------------")
print(" Phones\t\t\t{}\t {}\t{}".format(Quantity,cost,amount))
print("------------------------------------------------------")
...
print("\nAfter discount amount need to be pay",total_amount-dis)
print("\nThank You , Please Visit again")# Online Python compiler (interpreter) to run Python online.
